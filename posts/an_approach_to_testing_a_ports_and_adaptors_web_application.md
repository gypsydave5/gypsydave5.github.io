...
And when testing all other use cases, well - if we're driving the application directly, we're just passing a `UserId` around, testing authorziation and seeing what our different users can do.
